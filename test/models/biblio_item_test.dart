  ...
  group('BiblioItem model fromJson factory', () {
    test(
      ...
      () {
        ...
        final expectedNotForLoanStatus = BiblioItem.statusNotForLoan;
    ...
    test('fromJson creates a valid BiblioItem instance: borrowed item ', () {
      ...
      final expectedBorrowedStatus = BiblioItem.statusBorrowed;
    ...
    test('fromJson creates a valid BiblioItem instance: available item ', () {
      ...
      final expectedAvailableStatus = BiblioItem.statusAvailable;

      expect(biblioItemAvailable.overAllStatus, expectedAvailableStatus);
    });
  });

  group('BiblioItem model _getOberallStatus static method', () {
    test('not for loan item ', () {
      final jsonNotForLoanStatus = 1;
      final jsonCheckedOutDate = null;

      final overallStatus = BiblioItem.getOverallStatus(
        jsonNotForLoanStatus,
        jsonCheckedOutDate,
      );
      final expectedNotForLoanStatus = BiblioItem.statusNotForLoan;

      expect(overallStatus, expectedNotForLoanStatus);
    });

    test('borrowed item ', () {
      final jsonNotForLoanStatus = 0;
      final jsonCheckedOutDate = "2023-10-01";
      ...
      expect(overallStatus, expectedBorrowedStatus);
    });
    ...
    test('available item ', () {
      ...
      expect(overallStatus, expectedAvailableStatus);
    });
  });
}
